...
--
-- Host: localhost
-- Generation Time: Mar 15, 2020 at 02:11 AM
...
--
-- Table structure for table `krogerFood`
--

CREATE TABLE `krogerFood` (
  ...
  `temperature_indicator` varchar(40) NOT NULL,
  `heatSensitive` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Table structure for table `krogerUndef`
--

CREATE TABLE `krogerUndef` (
  `name` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Indexes for table `krogerFood`
--
ALTER TABLE `krogerFood`
